...
const EventCard = ({ event }) => {
  ...
  return (
    <div 
      className='max-w-xs bg-white shadow-lg rounded-xl overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl hover:cursor-pointer m-4'
